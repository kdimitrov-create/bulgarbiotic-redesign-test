      ...
      <div className="bb-container">
        <div className="bb-section-head reveal">
          <div>
            ...
            {/* H1 на началната страница.
              *
              * Досега целият сайт беше без H1 на най-важния си адрес - нито
              * едно заглавие от първо ниво (проверено на живо). Клиентът иска
              * H1, но НЕ в банерния слайдер, а той и без това няма заглавие.
              * Този ред е първото заглавие на страницата и казва точно за
              * какво е тя, значи е естественият H1.
              *
              * Класът остава `section-h2` нарочно: той носи вида на секционно
              * заглавие и нищо на екрана не помръдва. Секцията се рисува само
              * на началната, тоест нийде другаде не се появява втори H1. */}
            <h1 className="section-h2">Здравето започва в <span className="accent">микробиома.</span><br />Грижата започва с <span className="accent">превенция.</span></h1>
          </div>
          <div>
