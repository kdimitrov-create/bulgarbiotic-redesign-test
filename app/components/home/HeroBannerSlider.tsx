 ...
 */
type Slide = {desktop: string; mobile: string; link?: string};
  ...
  return (
    <section className={`bb-hslider${rounded ? ' bb-hslider--rounded' : ''}`} aria-label="Кампании" aria-roledescription="carousel">
      <div className="bb-hslider-track" style={{transform: `translateX(-${idx * 100}%)`}}>
        {SLIDES.map((s, i) => (
          <picture key={i} className="bb-hslider-slide">
      ...
      {/* Achievement stats — bottom-left overlay, delayed slide-in from the side (client). */}
      ...
      <style>{`
        ...
        .bb-hslider-slide { flex: 0 0 100%; width: 100%; display: block; aspect-ratio: 2033 / 773; }
        ...
        /* Achievement stats overlay — bottom-left, delayed side slide-in. */
        .bb-hslider-stats {
