...
const DEFAULT_SECTIONS: Section[] = [
  ...
  // „Ползи" е скрит: ключовите ползи вече стоят горе, в кутията за купуване,
  // тоест бутонът водеше нагоре към нещо, което вече е пред очите ти.
  // Записът остава коментиран, за да се върне с един ред, ако подредбата се смени.
