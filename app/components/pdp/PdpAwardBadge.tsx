  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        /* От 1024px, не от 768px: до тогава кутията за купуване е тясна и
           двете отличия едно до друго ставаха овали с накъсан на четири реда
           текст. Под този праг се пренасят едно под друго, както си беше. */
