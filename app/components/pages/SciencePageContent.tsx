    ...
    <>
        ...
        <div className="bb-sci-manifesto-grid">
          <div className="bb-sci-manifesto-text">
            ...
            <p className="bb-sci-manifesto-p">
              Не сме поредната хранителна добавка от рафта. Зад всяка капсула
              стои <strong>десетилетен научен опит</strong>, фармацевтичен
              контрол и щам, открит в българската планина още през 1905 г.
            </p>
      ...
      <section className="bb-sci-process not-prose">
        ...
        <ol className="bb-sci-process-list">
          {[
            {n: '01', h: 'Подбор на щамове', p: 'Започваме с клинично доказани пробиотични щамове с висока стабилност. L. bulgaricus винаги в основата на формулата.'},
            {n: '02', h: 'Формулиране', p: 'Учените комбинират щамовете синергично според терапевтичната нужда — стомах, имунитет, женско здраве, стрес.'},
